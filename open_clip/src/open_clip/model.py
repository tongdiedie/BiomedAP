...
class CLIP(nn.Module):
    ...
    def encode_text_prompts(self, prompts, tokenized_prompts, normalize: bool = False):
...
class CustomTextCLIP(nn.Module):
    ...
    def encode_text(self, text, inputs_embeds=False, y = None, normalize: bool = False):
        features = self.text(text,inputs_embeds,y)
        return F.normalize(features, dim=-1) if normalize else features
