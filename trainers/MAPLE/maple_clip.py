...
class MultiModalPromptLearner(nn.Module):
    def __init__(self, cfg, classnames, clip_model):
        ...
        self.class_token_position = cfg.TRAINER.MAPLE.CLASS_TOKEN_POSITION
...
class TextEncoder(nn.Module):
    ...
    def forward(self, prompts, tokenized_prompts, deep_compound_prompts_text):
...
class CLIP_Inplanted(nn.Module):
    def __init__(self, clip_model):
        ...
        self.dtype = clip_model.dtype
        self.n_ctx = 4
    def forward(self, x, shared_ctx, deep_compound_prompts_vision):
