...
from trainers.utils import cls_acc

from torch.optim.lr_scheduler import _LRScheduler

class ClipAdapter_PubMedCLIP(FSCLIPmethod):
    '''
    CLIP Adapter method
        @article{gao2021clip,
    ...
    def forward(self,
        ...
        # clip_ad_model.adapter = torch.load(self.cfg['cache_dir'] + "/best_clipA_" + str(self.cfg['shots']) + "shots.pt", weights_only=True)
